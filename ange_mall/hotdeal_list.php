...
<body class="sub ange_mall"><!-- 폴더별 클래스명 추가 -->
    ...
    <div class="page-header">
        ...
        <div class="btn-controls">
            <a href="/ange_mall/mileage_list.php" class="prev">
                <i class="icon-left-open-big">
                    <span class="sr-only">이전 페이지</span>
                </i>
            </a>
            <a href="/ange_mall/basket_list.php" class="next">
    ...
    <!-- sub content start -->
    <main id="content" class="hotdeal-list"><!-- 페이지명 클래스 -->
        <div class="container">
            <section>
                        ...
                        <ul class="row">
                            <li class="col-xs-6">
                                <a href="#">
									...
									<div class="clock">
										<img src="/assets/images/ange_mall/clock.png" alt="">
									</div>                                  	
                                    <figure>
