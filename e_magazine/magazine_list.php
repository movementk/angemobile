    ...
    <main id="content">
        <section class="magazine-list">
            <div class="container">
                ...
                <div class="section-content list-type-1">
                    <div class="type-btn">
                        <button type="button" class="btn btn-type-1 active">
                            <i class="icon-th"></i>
                        </button>
                        <button type="button" class="btn btn-type-2">
                    ...
                    <ul>
                        <li>
                            <a href="#">
                                ...
                                <div class="details">
                                    <h4>산후조리할 때 어떤 음식을 <br>챙겨 먹어야할까요?</h4>
                                    <ul class="icon-list">
